...
- [ ] **SETT-10**: Settings stores the default "from" address for Send Update (default: office@lasprezz.com)
- [ ] **SETT-11**: Settings stores the default "cc" address for Send Update (default: liz@lasprezz.com)
