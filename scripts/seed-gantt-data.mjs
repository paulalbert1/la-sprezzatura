...
const scheduleDependencies = [
  {
    _key: uuid(),
    fromCategory: "milestone",
    fromKey: KEYS.designPresentation,
    toCategory: "milestone",
    toKey: KEYS.designApproval,
    linkType: "e2s",
  },
  {
    _key: uuid(),
    fromCategory: "milestone",
    fromKey: KEYS.designApproval,
    toCategory: "contractor",
    toKey: KEYS.jpPainting,
    linkType: "e2s",
  },
  {
    _key: uuid(),
    fromCategory: "milestone",
    fromKey: KEYS.demoComplete,
    toCategory: "contractor",
    toKey: KEYS.eliteFloor,
    linkType: "e2s",
  },
  {
    _key: uuid(),
    fromCategory: "contractor",
    fromKey: KEYS.luxeLight,
    toCategory: "milestone",
    toKey: KEYS.roughInspection,
    linkType: "e2s",
  },
  {
    _key: uuid(),
    fromCategory: "procurement",
    fromKey: KEYS.wwFixtures,
    toCategory: "contractor",
    toKey: KEYS.precPlumb,
    linkType: "e2s",
  },
  {
    _key: uuid(),
    fromCategory: "milestone",
    fromKey: KEYS.finalWalk,
    toCategory: "milestone",
    toKey: KEYS.photoShoot,
    linkType: "e2s",
  },
];
