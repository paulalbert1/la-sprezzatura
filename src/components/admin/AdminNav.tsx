...
const navItems: NavItem[] = [
  ...
  { label: "Trades", href: "/admin/trades", icon: HardHat },
...
export default function AdminNav({ currentPath, businessName }: { currentPath: string; businessName: string }) {
  return (
    <nav className="flex flex-col h-full">
      ...
      <div className="mb-8 pl-[26px] pr-[18px]">
        <p
        ...
        {navItems.map((item) => {
          ...
          return (
            <a
              ...
              className={
                active
                  ? "pl-[26px] pr-[18px] py-2 flex items-center gap-[9px] text-[12.5px]"
                  : "pl-[26px] pr-[18px] py-2 flex items-center gap-[9px] text-[12.5px] transition-colors hover:bg-[#F5EDD8]/40"
              }
              style={{
      ...
      <a
        href="/admin/logout"
        className="pl-[26px] pr-[18px] py-2 flex items-center gap-[9px] text-[12.5px] transition-colors hover:bg-[#F5EDD8]/40"
        style={{
          color: "#9E8E80",
          fontFamily: "var(--font-sans)",
          letterSpacing: "0.02em",
